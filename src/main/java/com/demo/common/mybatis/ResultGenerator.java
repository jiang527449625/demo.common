...
public class ResultGenerator {
     ...
     * @return
     */
    public static Result genNoIntefaceResult(String msg) {
        String message = StringUtil.isEmpty(msg) ? "接口不存在" : msg;
        Head head = new Head(message, ResultCode.NOT_FOUND, "error");
        return new Result(head, message);
    }
